...
@Component({
    selector: 'app-ratchada',
    templateUrl: './ratchada.component.html',
    styleUrls: ['./ratchada.component.scss']
})
export class RatchadaComponent implements OnInit, OnDestroy {
    ...
    options = {
        ...
        datesRender: (e) => {
            ...
            this.GetCalendarByRoomId(_startdate, _enddate, 2)
        },
        selectable: true,
        editable: false
    }
    ...
    Booking() {
        this._Router.navigate(['/booking', 2, 'name', 'รัชดา']);
    }
