...
@Component({
    selector: 'app-ratchawong',
    templateUrl: './ratchawong.component.html',
    styleUrls: ['./ratchawong.component.scss']
})
export class RatchawongComponent implements OnInit, OnDestroy {
    ...
    options = {
        ...
        datesRender: (e) => {
            ...
            this.GetCalendarByRoomId(_startdate, _enddate, 4)
        },
        selectable: true,
        editable: false
    }
    ...
    Booking() {
        this._Router.navigate(['/booking', 4, 'name', 'ราชวงศ์']);
    }
