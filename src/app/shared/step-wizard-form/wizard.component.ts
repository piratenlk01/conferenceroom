...
export class WizardComponent implements AfterContentInit {
  ...
  @Input()
  isActiveBtnDone = false;   // ตอนกดบันทึก step สุดท้ายจะให้ปุ่มบันทึกกับปุ่มย้อนกลับหายไปรึป่าว ถ้าเป็น false จะหายไป ถ้าเป็น true จะไม่หาย (ดูที่โปรเจ็ค PMSgoal)

  @Input()
  isActiveFirstStep = 0;    // กำหนดหน้าแรกของstep ว่าจะให้เริ่มต้นที่ step ไหน
