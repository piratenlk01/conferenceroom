...
@Component({
    selector: 'app-songwad',
    templateUrl: './songwad.component.html',
    styleUrls: ['./songwad.component.scss']
})
export class SongwadComponent implements OnInit, OnDestroy {
    ...
    options = {
        ...
        datesRender: (e) => {
            ...
            this.GetCalendarByRoomId(_startdate, _enddate, 1)
        },
        selectable: true,
        editable: false
    }
    ...
    Booking() {
        this._Router.navigate(['/booking', 1, 'name', 'ทรงวาด']);
    }
